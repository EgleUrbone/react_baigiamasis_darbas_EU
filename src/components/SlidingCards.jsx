export default function SlidingCards() {
  return (
    <div className='w-[428px] overflow-y-hidden overflow-x-scroll flex gap-5 px-4 no-scrollbar md:w-[450px] lg:w-[500px] xl:w-[800px] xl:pl-0 xl:mb-10 2xl:w-[1400px] 2xl:mb-20'>
      <img
      ...
      <img
        className='object-cover w-[400px] h-[400px] rounded-2xl'
        src='/img/birds/calm-bird-branch.jpg'
        alt='fourth bird'
      />
    </div>
  );
